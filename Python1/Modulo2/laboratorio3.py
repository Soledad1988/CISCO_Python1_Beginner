...
#Escenario
#Te recomendamos encarecidamente que juegues con el código que hemos escrito para y realiza algunos 
#(quizás incluso destructivos) cambios. Siéntete libre de modificar cualquier parte del código,
...
#duplica la flecha, colocando ambas flechas una al lado de la otra; nota: una cadena se puede 
#multiplicar usando el siguiente truco: "string" * 2 producirá "stringstring" (pronto contaremos más al respecto)
...
#cambia cualquiera de las palabras print por otra cosa, que difiera solo en mayúsculas y minúsculas 
#(por ejemplo, Print) - qué sucede ahora?
