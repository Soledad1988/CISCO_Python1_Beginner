...
#Si el número elegido por el usuario es diferente al número secreto del mago, el usuario debería ver 
...
#imprimirse en la pantalla, y el mago debe decir las siguientes palabras: "¡Bien hecho, muggle! 
#Eres libre ahora."
#¡El mago está contando contigo! No lo decepciones.

#INFO EXTRA  
#Por cierto, observa la función print(). La forma en que lo hemos utilizado aquí se llama impresión multilínea. 
#Puedes utilizar comillas triples para imprimir cadenas en varias líneas para facilitar la lectura del texto o 
