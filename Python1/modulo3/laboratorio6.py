...
#más largo de los Estados Unidos (el más largo es el río Missouri). 
...
#tres Mississippi" tomará aproximadamente unos tres segundos reales de tiempo. A menudo lo usan los 
...
#"contar de forma mississippi" hasta cinco. Habiendo contado hasta cinco, el 
#programa debería imprimir en la pantalla el mensaje final "¡Listos o no, ahí voy!"
...
#método sleep() para suspender la ejecución de cada función posterior de print() dentro del bucle for 
#durante un segundo, de modo que el mensaje enviado a la consola se parezca a un conteo real. 
