#Desafío 2
#La contaminación del agua es cualquier cambio químico, físico o biológico en la calidad del agua que tiene 
# un efecto dañino en cualquier cosa viva que consuma ese agua. Cuando seres humanos beben el agua contaminada 
# tienen a menudo problemas de salud.

#La contaminación del agua se detecta en los laboratorios,  donde pequeñas muestras de agua se analizan para 
# diversos tipos de contaminantes. Los organismos vivos tales como pescados se pueden también utilizar para la 
...
pez = input('Ingrese el tamaño del pez: ')

if (pez == "normal"):
    print('Pez en buenas condicione')
elif (pez == "debajo de lo normal"):
    print('Pez con problemas de nutrición')
elif (pez == "encima de lo normal"):
